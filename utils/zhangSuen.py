...
'''
# This class implements the Zhang Suen thinning algorithm - It is very heavy and time consuming
# Refers to https://github.com/linbojin/Skeletonization-by-Zhang-Suen-Thinning-Algorithm
'''
class zhangSuen:
	def __init__(self):
		pass
